...
- Add production-oriented Excel export helpers via `exportExcelRows()`, `exportMultiSheetExcel()`, and `buildExcelResponse()`, with progress callbacks, abort support, and export diagnostics
